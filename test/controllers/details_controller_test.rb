...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { department: @detail.department, roll_no: @detail.roll_no, user_id: @detail.user_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { department: @detail.department, roll_no: @detail.roll_no, user_id: @detail.user_id } }
